...
export function CodeBlock({ code = "", language, filename }: CodeBlockProps) {
  ...
  return (
    <>
      ...
      {copied && (
        <div className="fixed bottom-8 right-8 z-[100] flex items-center gap-2.5 rounded-lg bg-emerald-500/15 border border-emerald-500/30 px-5 py-3 text-emerald-400 shadow-2xl animate-fade-in backdrop-blur-md">
